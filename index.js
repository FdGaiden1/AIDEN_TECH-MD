...
var session = conf.session.replace(/AIDEN_TECH-MD;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['AIDEN_TECH-MD', "safari", "1.0.0"],
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = 255750363194';
            const dj2 = 255750363194';
            const dj3 = "255750363194";
            const luffy = 255750363194';
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ AIDEN_TECH-MD connecting in your account...");
            }
            else if (connection === 'open') {
                console.log("✅ AIDEN_TECH-MD connected successfully☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("AIDEN_TECH-MD by AIDEN TECH installing cmds😇\n\n");
                ...
                console.log("AIDEN_TECH-MD successfully connected✅");

                await activateCrons();
                
                if((conf.DP).toLowerCase() === 'yes') {     
                let cmsg = `AIDEN_TECH-MD IS RUNNING NOW...
...
> THANK YOU FOR CHOOSING AIDEN_TECH-MD.\n`;
                await zk.sendMessage("255750363194.whatsapp.net", { text: cmsg });
                }
            }
